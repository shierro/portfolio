...
gulp.task('vendor:js', () =>
  gulp.src([
    ...
    `${dirs.src}/js/jquery.scrollify.js`
  ])
    .pipe(minify())
    .pipe(gulp.dest(`${dirs.dist}/js/vendor`))
);
...
gulp.task('vendor:css', () =>
  gulp.src([
    ...
    'node_modules/luxbar/build/luxbar.min.css'
  ])
...
gulp.task('typeface', function () {
  gulp.src('node_modules/typeface-montserrat/**')
    .pipe(gulp.dest(`${dirs.dist}/css/vendor/montserrat`))
    .pipe(livereload());
});
